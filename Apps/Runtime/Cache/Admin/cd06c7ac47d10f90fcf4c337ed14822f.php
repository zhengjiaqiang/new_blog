                        ...
                        <table width="100%" class="insert-tab">
                            <tbody><tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="" value="<?php echo ($config["website_title"]); ?>" size="85" name="title" class="common-text"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="" value="<?php echo ($config["website_desc"]); ?>" size="85" name="description" class="common-text"></td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td>
                        ...
                        <table width="100%" class="insert-tab">
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="" value="<?php echo ($config["linkman"]); ?>" size="85" name="contact" class="common-text"></td>
                                </tr>
                                <tr>
                                    <th><i class="require-red">*</i>联系电话：</th>
                                    <td><input type="text" id="" value="<?php echo ($config["linkmobile"]); ?>" size="85" name="phone" class="common-text"></td>
                                </tr>
                                <tr>
