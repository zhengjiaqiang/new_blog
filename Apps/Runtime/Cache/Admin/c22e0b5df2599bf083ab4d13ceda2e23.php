            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Category/add');?>"><i class="icon-font"></i>新增分类</a>
                ...
                <div class="result-content">
                    ...
                    <?php if(is_array($catList)): foreach($catList as $key=>$val): ?><tr id="tr_<?php echo ($val["cat_id"]); ?>">
                            <td class="tc"><input name="id[]" value="59" type="checkbox"> <?php echo ($val["cat_id"]); ?></td>
                            <td>
                                <input name="ids[]" value="59" type="hidden">
                                <input class="common-input sort-input" name="ord[]" value="<?php echo ($val["sort"]); ?>" type="text"> 
                            </td>
                            <td><a target="_blank" href="<?php echo U('Article/index',array('cat_id'=>$val['cat_id']));?>" title="<?php echo ($val["cat_name"]); ?>"><?php echo ($val["cat_name"]); ?></a>
                            </td>
                            <td><?php echo ($val["count"]); ?></td>

                            <!-- <td></td> -->
                            <td>
                                <a class="link-update" href="<?php echo U('Category/editor',array('catId'=>$val['cat_id']));?>">修改</a> | 
...
<script>
    ...
    function catDelete(aid)
    {
        ...
        if(bool)
        {
            ...
            var url = '/new_blog/index.php/Admin/Category/delete/aid/'+aid;
            xhr.open('get',url);
            xhr.send();
