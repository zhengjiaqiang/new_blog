    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Category/add');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
...
<!--                         <tr>
                            ...
                            <tr>
                                <th>排序：</th>
                                <td><input class="common-text" name="sort" size="50" value="50" type="text"></td>
                            </tr>
